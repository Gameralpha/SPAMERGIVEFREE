...
from spr import BOT_USERNAME, conn, session, spr, SUDOERS
...
async def help_command(_, message: Message):
    ...
    kb = ikb(
        {
            "Help": "bot_commands",
            "updates": "https://t.me/Official_Devil_Network",
            "Add Me To Your Group": f"https://t.me/{BOT_USERNAME}?startgroup=new",
            "Support Chat (for now)": "https://t.me/Official_Devil_Support",
        }
    )
    mention = message.from_user.mention
    await message.reply_photo(
        "https://telegra.ph/file/22f288349619a548cf9c6.png",
